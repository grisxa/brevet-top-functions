...
from plot_a_route import get_route_info, RouteNotFound, route_down_sample_factor
...
@patch("plot_a_route.add_last_checkpoint")
@patch("plot_a_route.find_checkpoints", return_value=mock_checkpoints)
@patch("plot_a_route.simplify_route", return_value=mock_route)
@patch("plot_a_route.route_down_sample_factor", return_value=0.1)
@patch("plot_a_route.convert_route_points", return_value=mock_route)
@patch("plot_a_route.download_data", return_value=mock_download)
...
@patch("plot_a_route.convert_route_points")
@patch("plot_a_route.download_data", return_value=mock_download_error)
...
@patch("plot_a_route.convert_route_points", return_value=[])
@patch("plot_a_route.download_data", return_value=mock_download)
